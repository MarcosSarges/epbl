...
class PlanosdeAula extends Component<Props> {
  state = {
    data: [
      { titulo: "ab", key: "a" },
      { titulo: "bcd", key: "b" },
  ...
  render() {
    return (
      <Container title="Planos de Aula" navigation={this.props.navigation}>
        ...
        <Button
          ...
          onPress={() => this.props.navigation.navigate("NovoPlanoDeAula")}
        >
          <Icon name="add" type="MaterialIcons" fontSize={40} />
          <Text>Novo Problema</Text>
        </Button>
      </Container>
    );
  }
